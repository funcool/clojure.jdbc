...
Since _clojure.jdbc_ is a young project there may be some API breakage. The last version,
concretely 0.5.0 introduces a new simplified api and deprecates all old api.
